...
library(Seurat)
# load("../data/comp-maco-seurat.RData") # Data not here.
...
genes <- c("Rlbp1", "Glul","Sox2","Nes","Vim", "Gfap","S100b", "Nrl","Rho", "Rcvrn", "Pde6g", "Prox1", "Lhx1", "Vsx2", "Pax6", "Slc32a1", "Gad1", "Gad2", "Chat", "Th", "Slc17a6", "Calb2", "Pou4f1", "Syn1","Rbfox3", "Tubb3", "Pvalb","Rbpms")
...
heat <- DotPlot(object = maco_plot, genes.plot = genes, cols.use = c("darkgreen", "red"), plot.legend = T, do.return = T, dot.scale = 10, x.lab.rot = T) + theme_classic() + scale_y_discrete(limits=c("Muller", "Astrocytes", "Photoreceptors", "Horizontal", "Bipolar","Amacrine", "RGCs")) + theme(axis.text.x = element_text(angle = 90, hjust = 1), axis.title.x = element_blank(), axis.title.y = element_blank()) + coord_flip()
```
...
jpeg(filename = "Dotplot.jpeg", width = 2000, height = 3000, res = 300)
heat
dev.off()
